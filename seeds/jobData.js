...
const jobData = [
    ...
    },
    {
        ...
        responsibilies:" Implement and maintain RESTful APIs using PHP and Node.js   Implement secure and scalable API solutions to meet business requirements   Ensuring cross-browser and cross-device compatibility  Writing clean, efficient, and scalable code      Troubleshooting and debugging issues",
