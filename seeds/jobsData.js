[
    {
        ...
        schedule_info:"Job Types: Full-time, Temporary, Contract",
        description:"Job Description:           We are looking for a Web Designer to create a minimalist website that effectively communicates information about our aims, research and achievements.In this role, you will have the opportunity to express your creativity, talent and drive and design a website that stands out.",
        responsibilies:"Responsibilities:           Create wireframes, prototypes, and mockups to visualize website layouts and user interfaces.Implement best practices in user experience and user interface design to enhance website functionality and usability.Work closely with developers and content creators to ensure integration of design elements and front-end functionality.Design and develop responsive and visually appealing websites that provide a great user experience across various devices. Maximize webpage visibility Provide feedback and thoughts on the team.",
